...
Create a test method: printData(int row, int column); This method should print the given cell. Example: printData(2,3); should print 2nd row,3rd column
    ...
    //Print all of the rows and print the elements on the 4th row
    @Test
    public void printRows(){
        ...
        for (WebElement eachRow:allRows){
            System.out.println("Row "+count+" => "+eachRow.getText());
            count++;
        }
    ...
    //Create a test method: printCells() and a the total number of cells in the table body and print all
    @Test
    public void printCells(){
        System.out.println("=======================ALL TABLE BODY CELLS==============================");
